...
```{r}
soil_chem <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/Soil_Chemistry_TimFegelRMRS/SoilChemAnalysis_16S_ASCC/ASCC_2023_WaterExtractable_Chemistry_EDITED_KMS.xlsx", sheet = "removed")
```
...
```{r}
ggplot(data=soil_chem,mapping=aes(x=ASCC_Site, y= DOC)) + 
...
```{r}
ggplot(data=soil_chem,mapping=aes(x=ASCC_Site, y= TDN)) + 
    geom_boxplot(aes(fill=ASCC_Site), show.legend =TRUE) + 
    geom_jitter(height = 0.1, width = 0.1) +
    facet_wrap(~Depth, nrow = 1,scales = "free_x")+
    stat_compare_means(comparisons=my_comparisons, method = "wilcox.test", label="p.signif", show.legend = FALSE, size = 6, hide.ns = FALSE, tip.length = 0.035, bracket.size = 0.5) +
...
```{r}
ggplot(data=soil_chem,mapping=aes(x=ASCC_Site, y= Na)) + 
    geom_boxplot(aes(fill=ASCC_Site), show.legend =TRUE) + 
    geom_jitter(height = 0.1, width = 0.1) +
    facet_wrap(~Depth, nrow = 1,scales = "free_x")+
    stat_compare_means(comparisons=my_comparisons, method = "wilcox.test", label="p.signif", show.legend = FALSE, size = 6, hide.ns = FALSE, tip.length = 0.035, bracket.size = 0.5) +
...
```{r}
ggplot(data=soil_chem,mapping=aes(x=ASCC_Site, y= NH4)) + 
    geom_boxplot(aes(fill=ASCC_Site), show.legend =TRUE) + 
    geom_jitter(height = 0.1, width = 0.1) +
    facet_wrap(~Depth, nrow = 1,scales = "free_x")+
    stat_compare_means(comparisons=my_comparisons, method = "wilcox.test", label="p.signif", show.legend = FALSE, size = 6, hide.ns = FALSE, tip.length = 0.035, bracket.size = 0.5) +
...
```{r}
ggplot(data=soil_chem,mapping=aes(x=ASCC_Site, y= K)) + 
    geom_boxplot(aes(fill=ASCC_Site), show.legend =TRUE) + 
    geom_jitter(height = 0.1, width = 0.1) +
    facet_wrap(~Depth, nrow = 1,scales = "free_x")+
    stat_compare_means(comparisons=my_comparisons, method = "wilcox.test", label="p.signif", show.legend = FALSE, size = 6, hide.ns = FALSE, tip.length = 0.035, bracket.size = 0.5) +
...
```{r}
ggplot(data=soil_chem,mapping=aes(x=ASCC_Site, y= Mg)) + 
    geom_boxplot(aes(fill=ASCC_Site), show.legend =TRUE) + 
    geom_jitter(height = 0.1, width = 0.1) +
    facet_wrap(~Depth, nrow = 1,scales = "free_x")+
    stat_compare_means(comparisons=my_comparisons, method = "wilcox.test", label="p.signif", show.legend = FALSE, size = 6, hide.ns = FALSE, tip.length = 0.035, bracket.size = 0.5) +
...
```{r}
ggplot(data=soil_chem,mapping=aes(x=ASCC_Site, y= Ca)) + 
    geom_boxplot(aes(fill=ASCC_Site), show.legend =TRUE) + 
    geom_jitter(height = 0.1, width = 0.1) +
    facet_wrap(~Depth, nrow = 1,scales = "free_x")+
    stat_compare_means(comparisons=my_comparisons, method = "wilcox.test", label="p.signif", show.legend = FALSE, size = 6, hide.ns = FALSE, tip.length = 0.035, bracket.size = 0.5) +
...
```{r}
ggplot(data=soil_chem,mapping=aes(x=ASCC_Site, y=Cl)) + 
    geom_boxplot(aes(fill=ASCC_Site), show.legend =TRUE) + 
    geom_jitter(height = 0.1, width = 0.1) +
    facet_wrap(~Depth, nrow = 1,scales = "free_x")+
    stat_compare_means(comparisons=my_comparisons, method = "wilcox.test", label="p.signif", show.legend = FALSE, size = 6, hide.ns = FALSE, tip.length = 0.035, bracket.size = 0.5) +
...
```{r}
ggplot(data=soil_chem,mapping=aes(x=ASCC_Site, y= NO3)) + 
    geom_boxplot(aes(fill=ASCC_Site), show.legend =TRUE) + 
    geom_jitter(height = 0.1, width = 0.1) +
    facet_wrap(~Depth, nrow = 1,scales = "free_x")+
    stat_compare_means(comparisons=my_comparisons, method = "wilcox.test", label="p.signif", show.legend = FALSE, size = 6, hide.ns = FALSE, tip.length = 0.035, bracket.size = 0.5) +
...
```{r}
ggplot(data=soil_chem,mapping=aes(x=ASCC_Site, y= PO4)) + 
    geom_boxplot(aes(fill=ASCC_Site), show.legend =TRUE) + 
    geom_jitter(height = 0.1, width = 0.1) +
    facet_wrap(~Depth, nrow = 1,scales = "free_x")+
    stat_compare_means(comparisons=my_comparisons, method = "wilcox.test", label="p.signif", show.legend = FALSE, size = 6, hide.ns = FALSE, tip.length = 0.035, bracket.size = 0.5) +
...
```{r}
ggplot(data=soil_chem,mapping=aes(x=ASCC_Site, y= SO4)) + 
    geom_boxplot(aes(fill=ASCC_Site), show.legend =TRUE) + 
    geom_jitter(height = 0.1, width = 0.1) +
    facet_wrap(~Depth, nrow = 1,scales = "free_x")+
    stat_compare_means(comparisons=my_comparisons, method = "wilcox.test", label="p.signif", show.legend = FALSE, size = 6, hide.ns = FALSE, tip.length = 0.035, bracket.size = 0.5) +
