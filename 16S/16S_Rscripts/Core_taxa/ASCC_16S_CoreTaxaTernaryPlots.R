...
library("ggvenn")
Data_VennDiagram <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_CoreTaxaAnalysis/ASCC16S_core_venn_SF.txt",header = T,check.names=FALSE)
ggvenn(Data_VennDiagram, c("0-5cm", "5-15cm","OM"),
       fill_color = c("#DB735C", "#EFA86E", "#B79667"),
       text_size = 2.5,
       set_name_size = 5.5) +
  scale_x_continuous(expand = expansion(mult = 0.5))

Data_VennDiagram2 <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_CoreTaxaAnalysis/ASCC16S_core_venn_TP.txt",header = T,check.names=FALSE)
ggvenn(Data_VennDiagram2, c("0-5cm", "5-15cm","OM"),
       fill_color = c("#DB735C", "#EFA86E", "#B79667"),
       text_size = 2.5,
       set_name_size = 5.5) +
  scale_x_continuous(expand = expansion(mult = 0.5))

Data_VennDiagram3 <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_CoreTaxaAnalysis/ASCC16S_core_venn_SJ.txt",header = T,check.names=FALSE)
ggvenn(Data_VennDiagram3, c("0-5cm", "5-15cm","OM"),
       fill_color = c("#DB735C", "#EFA86E", "#B79667"),
       text_size = 2.5,
       set_name_size = 5.5) +
  scale_x_continuous(expand = expansion(mult = 0.5))

Data_VennDiagram4 <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_CoreTaxaAnalysis/ASCC16S_core_venn_allsites.txt",header = T,check.names=FALSE)
ggvenn(Data_VennDiagram4, c("0-5cm", "5-15cm","OM"),
       fill_color = c("#DB735C", "#EFA86E", "#B79667"),
       text_size = 2.5,
       set_name_size = 5.5) +
  scale_x_continuous(expand = expansion(mult = 0.5))
