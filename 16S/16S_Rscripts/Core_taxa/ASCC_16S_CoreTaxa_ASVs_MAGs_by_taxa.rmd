...
```{r}
core_taxa70 <-  read_xlsx("/Users/kyasparks/Desktop/Kyas_PhD/CSU_2023_2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_CoreTaxaAnalysis/CoreTaxa_70_16S_ASCC_gtdb.xlsx", sheet = "d70")
```
...
```{r}
core_taxa70 <-  read_xlsx("/Users/kyasparks/Desktop/Kyas_PhD/CSU_2023_2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_CoreTaxaAnalysis/CoreTaxa_70_16S_ASCC_gtdb.xlsx", sheet = "d70_shallow")
```
...
```{r}
core_taxa70 <-  read_xlsx("/Users/kyasparks/Desktop/Kyas_PhD/CSU_2023_2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_CoreTaxaAnalysis/CoreTaxa_70_16S_ASCC_gtdb.xlsx", sheet = "d70_deep")
```
...
```{r}
core_taxa70 <-  read_xlsx("/Users/kyasparks/Desktop/Kyas_PhD/CSU_2023_2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_CoreTaxaAnalysis/CoreTaxa_70_16S_ASCC_gtdb.xlsx", sheet = "d70_OM")
```
...
```{r}
write_csv(merged_data_OUTPUT, "ASV_to_MAGs_output_OM.csv")
```
...
```{r}
write.csv(match_level_counts, "ASV_matching_percents_OM.csv")
```
...
```{r}
core_taxa70 <-  read_xlsx("/Users/kyasparks/Desktop/Kyas_PhD/CSU_2023_2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_CoreTaxaAnalysis/CoreTaxa_70_16S_ASCC_gtdb.xlsx", sheet = "d70_SF")
```
...
# Counting the number of ASVs that do not classify past the class level 
insuf_ASV_justCLASS <- sum(is.na(core_taxa70$o))
insuf_ASV_justfam <- sum(is.na(core_taxa70$f))
insuf_ASV_justgen <- sum(is.na(core_taxa70$g))
```
...
```{r}
write_csv(merged_data_OUTPUT, "ASV_to_MAGs_output_SF.csv")
```
...
```{r}
write.csv(match_level_counts, "ASV_matching_percents_SF.csv")
```
...
```{r}
core_taxa70 <-  read_xlsx("/Users/kyasparks/Desktop/Kyas_PhD/CSU_2023_2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_CoreTaxaAnalysis/CoreTaxa_70_16S_ASCC_gtdb.xlsx", sheet = "d70_TP")
```
...
```{r}
write_csv(merged_data_OUTPUT, "ASV_to_MAGs_output_TP.csv")
```
...
```{r}
write.csv(match_level_counts, "ASV_matching_percents_TP.csv")
```
...
```{r}
core_taxa70 <-  read_xlsx("/Users/kyasparks/Desktop/Kyas_PhD/CSU_2023_2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_CoreTaxaAnalysis/CoreTaxa_70_16S_ASCC_gtdb.xlsx", sheet = "d70_SJ")
```
...
# Make a new column 'match_level' and mark all of the above as having insufficient data to continue forward 
merged_data <- core_taxa70 %>%
  mutate(match_level = ifelse(is.na(g), "insufficient ASV classification", NA))
...
```{r}
write_csv(merged_data_OUTPUT, "ASV_to_MAGs_output_SJ.csv")
```
...
```{r}
write.csv(match_level_counts, "ASV_matching_percents_SJ.csv")
```