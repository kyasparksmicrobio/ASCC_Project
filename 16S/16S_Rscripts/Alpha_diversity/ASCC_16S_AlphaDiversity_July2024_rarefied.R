...
otus <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_coremetrics/ASCC_16S_feature_table_rarified_rem.txt") %>% 
  dplyr::rename(OTU_ID = "OTUS") %>%  
  as.data.frame()
...
alpha = as.data.frame(matrix(data = otus, nrow = 295, ncol = 4))
...
write.csv(alpha,"/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_alpha_diversity/AlphaDiversity_ASCC_16S_bothdepths_July2024_rarefied.csv") 

data <- read.csv("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_alpha_diversity/AlphaDiversity_ASCC_16S_bothdepths_July2024_rarefied_plusmeta.csv", header = TRUE,row.names = 1)
...
data <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_metadata/ASCC_16S_feature_table_rarified_rem_RELABUND_plusmeta.txt", header = TRUE,row.names = 1)
