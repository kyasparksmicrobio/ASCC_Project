...
#write.csv(alpha,"/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_alpha_diversity/AlphaDiversity_ASCC_16S_bothdepths_July2024.csv") 

data <- read.csv("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_alpha_diversity/AlphaDiversity_ASCC_16S_bothdepths_July2024.csv", header = TRUE,row.names = 1)
...
ggplot(data, aes(x=Depth, y=Shannon)) + 
  ...
  labs(title = "Shannon's H Boxplots")+
