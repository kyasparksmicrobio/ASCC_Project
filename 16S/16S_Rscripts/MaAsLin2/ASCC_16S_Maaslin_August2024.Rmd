...
### Transposes otus so samples are in rows (MaAsLin2s required format), storing it as transposed_table1.
### Replaces the transposed OTU tables column names with taxonomy labels
