...
### Plotting volcano plots, highlighting consistent taxa across sites


# BE SURE TO CHECK YOUR MAASLIN OUTPUT SO YOU KNOW WHAT THE COEFFICIENTS MEAN
## example:
...
```{r}
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_allresults_COMBINED_16S.xlsx", sheet = "SF v TP shallow") %>% 
...
sf5_discrim <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_discrimcomparisons_040725.xlsx",sheet = "SF5_discrim") %>% 
  pull(OTUID) %>% trimws()

tp5_discrim <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_discrimcomparisons_040725.xlsx", sheet = "TP5_discrim") %>% 
  pull(OTUID) %>% trimws()
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_allresults_COMBINED_16S.xlsx", sheet = "TP v SJ shallow") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))

# Load discriminant OTUs
sj5_discrim <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_discrimcomparisons_040725.xlsx", sheet = "SJ5_discrim") %>% 
  pull(OTUID) %>% trimws()
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_allresults_COMBINED_16S.xlsx", sheet = "SJ v SF shallow") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_allresults_COMBINED_16S.xlsx", sheet = "SJ v SF deep") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))

# Load discriminant OTUs
sj15_discrim <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_discrimcomparisons_040725.xlsx", sheet = "SJ15_discrim") %>% 
  pull(OTUID) %>% trimws()

sf15_discrim <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_discrimcomparisons_040725.xlsx", sheet = "SF15_discrim") %>% 
  pull(OTUID) %>% trimws()
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_allresults_COMBINED_16S.xlsx", sheet = "SF v TP deep") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))
...
tp15_discrim <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_discrimcomparisons_040725.xlsx", sheet = "TP15_discrim") %>% 
  pull(OTUID) %>% trimws()
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_allresults_COMBINED_16S.xlsx", sheet = "TP v SJ deep") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_allresults_COMBINED_16S.xlsx", sheet = "SJ v SF OM") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))

# Load discriminant OTUs
sjom_discrim <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_discrimcomparisons_040725.xlsx", sheet = "SJOM_discrim") %>% 
  pull(OTUID) %>% trimws()

sfom_discrim <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_discrimcomparisons_040725.xlsx", sheet = "SFOM_discrim") %>% 
  pull(OTUID) %>% trimws()
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_allresults_COMBINED_16S.xlsx", sheet = "SF v TP OM") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))
...
tpom_discrim <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2028/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_discrimcomparisons_040725.xlsx", sheet = "TPOM_discrim") %>% 
  pull(OTUID) %>% trimws()
