...
core_taxa_data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_CoreTaxaAnalysis/ASCC_16S_CoreTaxa_70perc_allsitescombo.xlsx", sheet = "d70") %>%
...
data <- data %>%
  ...
  mutate(
    ...
    # ✅ Only highlight if the OTU is discriminant AND significant (qval < 0.05)
...
```{r}
# Save the volcano plot as a square SVG file
ggsave(filename = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Plots/volcano_plot_SFTP15.svg",
       plot = plot, 
       width = 6, height = 6, dpi = 300, device = "svg")
```
...
```{r}
# Save the volcano plot as a square SVG file
ggsave(filename = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Plots/volcano_plot_SFSJ15.svg",
       plot = plot, 
       width = 6, height = 6, dpi = 300, device = "svg")
```
...
```{r}
# Save the volcano plot as a square SVG file
ggsave(filename = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Plots/volcano_plot_TPSJ15.svg",
       plot = plot, 
       width = 6, height = 6, dpi = 300, device = "svg")
```
...
```{r}
# Save the volcano plot as a square SVG file
ggsave(filename = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Plots/volcano_plot_SFTPOM.svg",
       plot = plot, 
       width = 6, height = 6, dpi = 300, device = "svg")
```
...
```{r}
# Save the volcano plot as a square SVG file
ggsave(filename = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Plots/volcano_plot_SFSJOM.svg",
       plot = plot, 
       width = 6, height = 6, dpi = 300, device = "svg")
```
...
# Save to CSV (optional)
write.csv(non_highlighted_otus, "non_highlighted_OTUIDs_tpsjOM.csv", row.names = FALSE)
...
```{r}
# Read in main dataset
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_maaslin/Maaslin_ITS_allresults.xlsx", sheet = "output_ITS_SJ_SF") %>% as.data.frame()

# Read SF5 discriminant OTUs
discriminant_otus_SF5 <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_maaslin/ASCC_ITS_Maaslin2_finalresultscombined.xlsx", sheet = "all") %>%
  select(OTUID) %>%
  pull()
...
# Combine both discriminant OTU lists
discriminant_otus <- unique(c(discriminant_otus_SF5))
