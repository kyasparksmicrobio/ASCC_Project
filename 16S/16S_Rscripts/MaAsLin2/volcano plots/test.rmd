...
```{r}
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_maaslin/MaaslinResults_cleaned_allSheets.xlsx", sheet = "SF v TP shallow") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))
```

# SF v TP shallow 0-5 cm
```{r}
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2024/MaaslinResults_cleaned_allSheets_FINAL.xlsx", sheet = "SF v TP shallow")%>% 
  mutate(OTUID = trimws(as.character(OTUID))) 
...
# Save plot
ggsave(filename = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/volcano_SF_v_TP_shallow.svg",
...
write.csv(outliers_df,
          file = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/outliers_SF_v_TP_shallow.csv",
          row.names = FALSE)
```
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2024/MaaslinResults_cleaned_allSheets_FINAL.xlsx", sheet = "TP v SJ shallow") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))
...
# Save plot
ggsave(filename = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/volcano_TP_v_SJ_shallow.svg",
...
write.csv(outliers_df,
          file = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/outliers_TP_v_SJ_shallow.csv",
          row.names = FALSE)
```
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2024/MaaslinResults_cleaned_allSheets_FINAL.xlsx", sheet = "SJ v SF shallow") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))
...
# Save plot
ggsave(filename = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/volcano_SJ_v_SF_shallow.svg",
...
write.csv(outliers_df,
          file = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/outliers_SJ_v_SF_shallow.csv",
          row.names = FALSE)
```
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2024/MaaslinResults_cleaned_allSheets_FINAL.xlsx", sheet = "SJ v SF deep") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))
...
# Save plot
ggsave(filename = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/volcano_SJ_v_SF_deep.svg",
...
write.csv(outliers_df,
          file = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/outliers_SJ_v_SF_deep.csv",
          row.names = FALSE)
```
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2024/MaaslinResults_cleaned_allSheets_FINAL.xlsx", sheet = "SF v TP deep") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))
...
# Save plot
ggsave(filename = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/volcano_SF_v_TP_deep.svg",
...
write.csv(outliers_df,
          file = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/outliers_SF_v_TP_deep.csv",
          row.names = FALSE)
```
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2024/MaaslinResults_cleaned_allSheets_FINAL.xlsx", sheet = "TP v SJ deep") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))
...
# Save plot
ggsave(filename = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/volcano_TP_v_SJ_deep.svg",
...
write.csv(outliers_df,
          file = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/outliers_TP_v_SJ_deep.csv",
          row.names = FALSE)
```
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2024/MaaslinResults_cleaned_allSheets_FINAL.xlsx", sheet = "SJ v SF OM") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))
...
# Save plot
ggsave(filename = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/volcano_SJ_v_SF_om.svg",
...
write.csv(outliers_df,
          file = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/outliers_SJ_v_SF_om.csv",
          row.names = FALSE)
```
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2024/MaaslinResults_cleaned_allSheets_FINAL.xlsx", sheet = "SF v TP OM") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))
...
# Save plot
ggsave(filename = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/volcano_SF_v_TP_om.svg",
...
write.csv(outliers_df,
          file = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_Plots/outliers_SF_v_TP_om.csv",
          row.names = FALSE)
```
...
```{r}
# Load main results
data <- read_excel("/Users/kyasparks/Desktop/CSU 2023-2024/MaaslinResults_cleaned_allSheets_FINAL.xlsx", 
                   sheet = "TP v SJ OM") %>% 
  mutate(OTUID = trimws(as.character(OTUID)))
...
combined_plot <- (plot_tp_sf_om + plot_tp_sj_om + plot_sj_sf_om)/
                (plot_sf_tp_shallow + plot_tp_sj_shallow + plot_sf_sj_shallow) /
