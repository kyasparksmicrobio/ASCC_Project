...
Maaslin2(input_data = otus_SF_TP,
          ...
          output = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SF_TP",
          fixed_effects = "Site",
...
Maaslin2(input_data = otus_TP_SJ,
          ...
          output = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_TP_SJ",
          fixed_effects = "Site", 
          max_significance = 1.0)
 
Maaslin2(input_data = otus_SJ_SF,
          input_metadata = metadata_SJ_SF,
          output = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SJ_SF2",
          fixed_effects = "Site",
          max_significance = 1.0)

Maaslin2(input_data = otus_SF_TP_shallow,
          input_metadata = metadata_SF_TP_shallow,
          output = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SF_TP_shallow2",
          fixed_effects = "Site", 
          max_significance = 1.0)
 
Maaslin2(input_data = otus_TP_SJ_shallow,
          input_metadata = metadata_TP_SJ_shallow,
          output = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_TP_SJ_shallow2",
          fixed_effects = "Site", 
          max_significance = 1.0)

Maaslin2(input_data = otus_SJ_SF_shallow,
          input_metadata = metadata_SJ_SF_shallow,
          output = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SJ_SF_shallow2",
          fixed_effects = "Site", 
          max_significance = 1.0)

Maaslin2(input_data = otus_SF_TP_deep,
          input_metadata = metadata_SF_TP_deep,
          output = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SF_TP_deep2",
          fixed_effects = "Site", 
          max_significance = 1.0)
 
Maaslin2(input_data = otus_TP_SJ_deep,
          input_metadata = metadata_TP_SJ_deep,
          output = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_TP_SJ_deep2",
          fixed_effects = "Site", 
          max_significance = 1.0)

Maaslin2(input_data = otus_SJ_SF_deep,
          input_metadata = metadata_SJ_SF_deep,
          output = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SJ_SF_deep2",
          fixed_effects = "Site", 
          max_significance = 1.0)

Maaslin2(input_data = otus_SF_TP_OM,
          input_metadata = metadata_SF_TP_OM,
          output = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SF_TP_OM2",
          fixed_effects = "Site", 
          max_significance = 1.0)

Maaslin2(input_data = otus_TP_SJ_OM,
          input_metadata = metadata_TP_SJ_OM,
          output = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_TP_SJ_OM2",
          fixed_effects = "Site", 
          max_significance = 1.0)

Maaslin2(input_data = otus_SJ_SF_OM,
          input_metadata = metadata_SJ_SF_OM,
          output = "/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SJ_SF_OM2",
          fixed_effects = "Site", 
          max_significance = 1.0)
```
...
data.sftp <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//Maaslin_output/output_16S_SF_TP/significant_results.tsv")

data.tpsj <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_TP_SJ/significant_results.tsv")

data.sjsf <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SJ_SF/significant_results.tsv")

data.sftp.shal <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SF_TP_shallow/significant_results.tsv")

data.tpsj.shal <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_TP_SJ_shallow/significant_results.tsv")

data.sjsf.shal <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SJ_SF_shallow/significant_results.tsv")

data.sftp.deep <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SF_TP_deep/significant_results.tsv")

data.tpsj.deep <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_TP_SJ_deep/significant_results.tsv")

data.sjsf.deep <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SJ_SF_deep/significant_results.tsv")

data.sftp.OM <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SF_TP_OM/significant_results.tsv")

data.tpsj.OM <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_TP_SJ_OM/significant_results.tsv")

data.sjsf.OM <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/Maaslin_output//output_16S_SJ_SF_OM/significant_results.tsv")
```
...
data.sftp.shal$color <- ifelse(data.sftp.shal$coef >= 0, "Positive", "Negative")
plot2 <- ggplot(data.sftp.shal, aes(x = coef, y =feature, fill = color)) +
