...
otus <- read_excel("/Users/kyasparks/Desktop/Desktop - MacBook Pro (2)/Kyas_PhD/CSU_2023_2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/ASCC_16S_feature_table_Maaslin_combo.xlsx", sheet = "DEEP")%>%
...
otus2 <- read_excel("/Users/kyasparks/Desktop/Desktop - MacBook Pro (2)/Kyas_PhD/CSU_2023_2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/ASCC_16S_feature_table_Maaslin_combo.xlsx", sheet = "DEEP")%>%
...
otus3 <- read_excel("/Users/kyasparks/Desktop/Desktop - MacBook Pro (2)/Kyas_PhD/CSU_2023_2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/ASCC_16S_feature_table_Maaslin_combo.xlsx", sheet = "DEEP")%>%
...
```{r}
deep = ggplot(combo_all1, aes(y=Phylum,x=rel_abund, color=Site ))+
  stat_summary(fun.data = median_hilow, geom = "pointrange",
 ...
 # Customize color manually for the 'Site' variable
  ...
  labs(title = "Relative Abundance of Phyla by Site for 5-15 cm Combined",
...
```{r}
combined_plot <- (shallow + deep +OM) + 
  plot_layout(ncol = 1, guides = "collect")  # Stack in one column, collecting legend
