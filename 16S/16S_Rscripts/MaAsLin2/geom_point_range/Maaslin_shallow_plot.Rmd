---
title: "Maaslin16S_plots_shallow"
author: "Kya Sparks"
date: "`r Sys.Date()`"
...
otus <- read_excel("/Users/kyasparks/Desktop/Desktop - MacBook Pro (2)/Kyas_PhD/CSU_2023_2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/ASCC_16S_feature_table_Maaslin_combo.xlsx", sheet = "SHALLOW")%>%
...
otus2 <- read_excel("/Users/kyasparks/Desktop/Desktop - MacBook Pro (2)/Kyas_PhD/CSU_2023_2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/ASCC_16S_feature_table_Maaslin_combo.xlsx", sheet = "SHALLOW")%>%
...
otus3 <- read_excel("/Users/kyasparks/Desktop/Desktop - MacBook Pro (2)/Kyas_PhD/CSU_2023_2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/16S/16S_Maaslin/ASCC_16S_feature_table_Maaslin_combo.xlsx", sheet = "SHALLOW")%>%
...
"p__Cyanobacteria" | Phylum =="p__Chloroflexi" | Phylum == "
p__Myxococcota" | Phylum == "p__Methylomirabilota" | Phylum == "p__Firmicutes")

```

```{r}
combo_all1$Site  <- factor(combo_all1$Site, levels=c('SF','TP','SJ'))
```

```{r}
shallow = ggplot(combo_all1, aes(y=Phylum,x=rel_abund, color=Site ))+
  stat_summary(fun.data = median_hilow, geom = "pointrange",
 ...
 # Customize color manually for the 'Site' variable
  ...
  labs(title = "Relative Abundance of Phyla by Site for 0-5 cm Combined",
...
```{r}
combined_plot <- (OM |shallow) /
                 (plot_spacer() |deep | plot_spacer()) +
