...
otus <- read.delim("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_denoise_files/ASCC_ITS_feature_table_OG_rarefied_rem.txt") %>% 
...
alpha = as.data.frame(matrix(data = otus, nrow = 293, ncol = 4))
...
write.csv(alpha,"/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_alpha_diversity/AlphaDiversity_ASCC_ITS_bothdepths_August2024_rarefied.csv") 

data <- read.csv("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_alpha_diversity/AlphaDiversity_ASCC_ITS_bothdepths_August2024_rarefied_meta_added.csv", header = TRUE,row.names = 1)
...
data <- read.csv("/Users/kyasparks/Desktop/CSU 2023-2024/Projects/ASCC/ASCC_July2024_USETHIS_ks/ITS/ITS_denoise_files/ASCC_ITS_feature_table_rem_RELABUND_rarefied_RELABUND.csv", header = TRUE,row.names = 1)
