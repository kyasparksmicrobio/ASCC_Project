...
phylum_order <- phylum_totals$Genus

# STEP 5: Define expansion function to fill missing Depth/Genus pairs
expand_genus_grid <- function(data, all_Genus, phylum_order) {
  ...
  data$Genus <- factor(data$Genus, levels = rev(phylum_order))
...
sf_data <- expand_genus_grid(sf_data, shared_Genus, phylum_order)
tp_data <- expand_genus_grid(tp_data, shared_Genus, phylum_order)
sj_data <- expand_genus_grid(sj_data, shared_Genus, phylum_order)
